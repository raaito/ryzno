...
const ContactSection = () => {
    return (
        <section id="contact" style={{ padding: '6rem 0', position: 'relative', width: '100%', overflow: 'hidden' }}>
            <div className="container" style={{ width: '100%', padding: '0 15px', boxSizing: 'border-box' }}>
                ...
                >
                    ...
                    >
                        <form onSubmit={(e) => e.preventDefault()} style={{ display: 'grid', gap: '1rem', width: '100%' }}>
